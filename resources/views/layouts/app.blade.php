...
<head>
    ...
    <title>{{ config('app.name', 'LaraFinance') }}</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            @if( Auth::user()->role->role_title == 'Admin')
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/admin/company">Company</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">User</a>
                                </li>
                            @elseif(Auth::user()->role->role_title == 'Company')
                                <li class="nav-item">
                            ...
                            @elseif(Auth::user()->role->role_title == 'Customer')
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/customer/company">Company</a>
                                </li>
                            @endif
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}({{ Auth::user()->role->role_title }})
                                </a>
